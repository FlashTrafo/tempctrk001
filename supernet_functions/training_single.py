...
class TrainerSupernet:
    ...
    def __init__(self, criterion, w_optimizer, w_scheduler, logger, writer, args):
    ...
    def train_loop(self, train_w_loader, test_loader, model):
...
#             self.w_scheduler.step()
    ...
    def _epoch_stats_logging(self, start_time, epoch, val_or_train, info_for_logger=''):
        ...
        self.logger.info(info_for_logger+val_or_train + ": [{:3d}/{}] Time {:.2f}".format(epoch+1, 
                         self.cnt_epochs, time.time() - start_time))
